...
def apply_vulnerability_delta(state: ExecutionState, delta: VulnerabilityDelta) -> ExecutionState:
    ...
    for f_item in delta.findings:
        ...
        elif isinstance(f_item, dict) and 'title' in f_item:
            finding = Finding(
                id=f_item.get('id', ''),
                ...
                poc=f_item.get('poc', ''),
                plugin=f_item.get('plugin', 'unknown'),
                tool_version=f_item.get('tool_version', 'unknown'),
                target=f_item.get('target', 'unknown'),
                url=f_item.get('url', 'unknown'),
                template_id=f_item.get('template_id', 'unknown'),
                category=f_item.get('category', 'unknown'),
                tags=tuple(f_item.get('tags', [])),
                recommendation=f_item.get('recommendation', ''),
                timestamp=f_item.get('timestamp', ''),
                command=f_item.get('command', ''),
                replay_command=f_item.get('replay_command', ''),
                parser=f_item.get('parser', 'unknown'),
                metadata=f_item.get('metadata', {}),
                source_tool=f_item.get('source_tool', 'unknown'),
