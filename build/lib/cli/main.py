...
from cli.commands_benchmark import app as benchmark_app
from cli.commands_verify import app as verify_app
...
app.add_typer(benchmark_app, name="")
app.add_typer(verify_app, name="")
